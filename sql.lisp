...
(defun blockchain-to-sql (blockchain-file sql-file)
  "Export the data from the blockchain in BLOCKCHAIN-FILE to a sql script named SQL-FILE."
  (with-open-file (sql sql-file :direction :output :if-exists :supersede)
    (let* ((block-id 0)
      ...
      (parse-blockchain blockchain-file))))
